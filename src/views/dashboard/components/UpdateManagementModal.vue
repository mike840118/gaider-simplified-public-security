          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="4">
                ...
                <span class="ml-4">{{ $t('file_manage.table.bp_format') }} <input type="text" class="w-20 ml-2" />
                  mmHg</span>
              </td>
            </tr>
            <tr>
                ...
                <div class="flex-start"><label><input type="radio" name="surgery" /> {{ $t('common.yes')
                  ...
                  <div class="ml-2 flex-col">
                    <span v-for="i in 3" :key="i">{{ i }}、{{ $t('file_manage.options.item_name') }}
                      <input type="text" class="border-b" /> {{ $t('common.time') }} <input type="text"
                        class="w-10 border-b" /> {{ $t('common.year') }} <input type="text" class="w-10 border-b" /> {{
                          $t('common.month') }}</span>
                  </div>
                </div>
              </td>
            ...
            <tr>
              ...
              <td colspan="7">
                ...
                <div>{{ $t('file_manage.table.disability_code') }} <input type="text" class="border-b" /></div>
              </td>
            </tr>
          </tbody>
        </table>
